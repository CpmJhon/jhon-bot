...
auth: state,
browser: [`Chika Bot By ${ownername}`, "Chrome", "1.0.0"],
...
DeepakBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6285894955362@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6285894955362@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"url": `https://youtube.com/@galeri_car_cpm8048`,
"productImageCount": 1,
"salePriceAmount1000": "0"
},
"businessOwnerJid": `6285894955362@s.whatsapp.net`
}
}, options)
